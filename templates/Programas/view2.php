...
<div class="programas index content">
    <?= $this->Html->link(__('actualizar'), ['action' => 'pro'],['class' => 'button float-right']) ?>
    <?= $this->Html->link(__('Descargar Excel'), ['action' => 'export'],['class' => 'button float-right']) ?>
    <h3 class="tabla"><?= __('Ejecución Presupuestaria') ?></h3>
    <div class="table-responsive">
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <td class="actions">  
                        <?= $this->Html->link(__('Ver'), ['controller' => 'items','action' => 'view7', $data->prog_id,$data->prog_nombre]) ?>         
                    </td>
                    <td><?= $this->Html->link($data->prog_nombre,['action' => 'detalle', $data->prog_id,$data->prog_nombre]) ?></td>
