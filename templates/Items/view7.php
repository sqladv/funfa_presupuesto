...
<div class="programas index content">
    <?= $this->Html->link(__('Descargar Excel'), ['action' => 'export7',$id],['class' => 'button float-right']) ?>
    <h3 class="tabla"><?= __('Agrupaciones - Programa '),h($id2) ?></h3>
    <div class="table-responsive">
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <td class="actions">  
                        <?= $this->Html->link(__('Ver'), ['action' => 'view5', $data->agru_cod,$id2,$id]) ?>         
                    </td>
                    <td><?= h($data->agru_cod) ?></td>
                    <td><?= $this->Html->link($data->agru_nombre,['action' => 'agru', $data->agru_cod,$id2,$id]) ?></td>
