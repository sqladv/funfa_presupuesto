...
<div class="items index content">
    <?= $this->Html->link(__('actualizar'), ['action' => 'pro',$id,$id2],['class' => 'button float-right']) ?>
     <?= $this->Html->link(__('Descargar Excel'), ['action' => 'export5',$id3,$id2],['class' => 'button float-right']) ?>
    <h3 class="tabla"><?= __('Simulación Presupuestaria - Programa:'),h($id2) ?></h3>
    <div class="table-responsive">
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <td class="actions">
                         <?= $this->Html->link(__('Simular'), ['action' => 'simu', $data->item_id, $data->pres_anual,$data->gasto_real,
                      $data->sim_enero,$data->sim_febrero,$data->sim_marzo,$data->sim_abril,$data->sim_mayo,$data->sim_junio,$data->sim_julio,$data->sim_agosto,$data->sim_septiembre,$data->sim_octubre,
                      $data->sim_noviembre,$data->sim_diciembre,$id2,$id]) ?> 
                    </td>
                    <td><?= h($data->item_cod) ?></td>
                    <td><?= $this->Html->link($data->item,['action' => 'detalle2', $data->item_id,$data->item]) ?></td>
                    ...
                    <td class="<?php echo $clase?>"><li></li></td>
                     <td><?php
                        ...
                        if ( date('m')==1) {                                       
                                        echo '$',$this->Number->format($data->sim_enero); 
                                        } 
                        if ( date('m')==2) {                                       
                                            echo'$',$this->Number->format($data->sim_febrero); 
                                        } 
                        if ( date('m')==3) {                                       
                                            echo'$',$this->Number->format($data->sim_marzo); 
                                        }
                        if ( date('m')==4) {                                       
                                            echo'$',$this->Number->format($data->sim_abril); 
                                        } 
                        if ( date('m')==5) {                                       
                                            echo'$',$this->Number->format($data->sim_mayo); 
                                        } 
                        if ( date('m')==6) {                                       
                                            echo'$',$this->Number->format($data->sim_junio); 
                                        } 
                        if ( date('m')==7) {                                       
                                            echo'$',$this->Number->format($data->sim_julio); 
                                        } 
                        if ( date('m')==8) {                                       
                                            echo'$',$this->Number->format($data->sim_agosto); 
                                        }
                        if ( date('m')==9) {                                       
                                            echo'$',$this->Number->format($data->sim_septiembre); 
                                        } 
                        if ( date('m')==10) {                                       
                                            echo'$',$this->Number->format($data->sim_octubre); 
                                        }
                        if ( date('m')==11) {                                       
                                            echo'$',$this->Number->format($data->sim_noviembre); 
                                        }
                        if ( date('m')==12) {                                       
                                            echo'$',$this->Number->format($data->sim_diciembre); 
                                        } 
                                    ?></td> 
                    <td><?php
