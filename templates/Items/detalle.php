...
<div class="items index content">
    ...
    <h3 class="tabla"><?= __('Item:'),h($id2) ?></h3>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?=  $this->Html->link($this->Number->format($data->solicitado_mes,['before' => '$']), ['action' => 'solicitud', $id3,$data->mes_id,$data->mes_nombre,$id2])?></td>
                    <td><?=  $this->Html->link($this->Number->format($data->gasto_ren_mes,['before' => '$']), ['action' => 'centros2', $id3,$data->mes_id,$data->mes_nombre,$id2])?></td>
                    <td><?=  $this->Html->link($this->Number->format($data->gasto_mesnual,['before' => '$']), ['controller' => 'Detalles','action' => 'detalle', $id3,$data->mes_nombre,$id2])?></td>
