...
<div class="items index content">
    <?= $this->Html->link(__('Descargar Excel'), ['action' => 'export6',$id2,$id],['class' => 'button float-right']) ?>
    <h3 class="tabla"><?= __('Simulacion - Item:'),h($id2) ?></h3>
        ...
        <table>
            <thead>
                <tr>               
                    ...
                    <th><?= $this->Paginator->sort('gasto_mesnual','Gasto') ?></th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= $this->Number->format($data->gasto_mesnual,['before' => '$']) ?></td>
