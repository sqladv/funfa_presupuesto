...
<div class="programas index content">
    <?= $this->Html->link(__('Descargar Excel'), ['action' => 'export9',$id],['class' => 'button float-right']) ?>
    <h3 class="tabla"><?= __('Simulacion - Agrupaciones - Programa '),h($id2) ?></h3>
        ...
        <table>
            <thead>
                <tr>   
                    ...
                    <th><?= $this->Paginator->sort('agru_nombre','Agrupacion') ?></th>
            ...
            <tbody>
                ...
                <tr>
                    <td class="actions">  
                        <?= $this->Html->link(__('Ver'), ['action' => 'view6', $data->agru_cod,$id2,$id]) ?>         
                    </td>
                    <td><?= h($data->agru_cod) ?></td>
                    <td><?= $this->Html->link($data->agru_nombre,['action' => 'simagru', $data->agru_cod,$id2,$id]) ?></td>
