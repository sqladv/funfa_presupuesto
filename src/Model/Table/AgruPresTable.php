 ...
 *
 * @method \App\Model\Entity\AgruPre get($primaryKey, $options = [])
 * @method \App\Model\Entity\AgruPre newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\AgruPre[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\AgruPre|false save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\AgruPre saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\AgruPre patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\AgruPre[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\AgruPre findOrCreate($search, callable $callback = null, $options = [])
 */
class AgruPresTable extends Table
{
    /**
     * Initialize method
     *
