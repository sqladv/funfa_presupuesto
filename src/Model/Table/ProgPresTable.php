 ...
 *
 * @method \App\Model\Entity\ProgPre get($primaryKey, $options = [])
 * @method \App\Model\Entity\ProgPre newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\ProgPre[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\ProgPre|false save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ProgPre saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ProgPre patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\ProgPre[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\ProgPre findOrCreate($search, callable $callback = null, $options = [])
 */
class ProgPresTable extends Table
{
    /**
     * Initialize method
     *
