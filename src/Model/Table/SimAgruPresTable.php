 ...
 *
 * @method \App\Model\Entity\SimAgruPre get($primaryKey, $options = [])
 * @method \App\Model\Entity\SimAgruPre newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\SimAgruPre[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\SimAgruPre|false save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\SimAgruPre saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\SimAgruPre patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\SimAgruPre[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\SimAgruPre findOrCreate($search, callable $callback = null, $options = [])
 */
class SimAgruPresTable extends Table
{
    /**
     * Initialize method
     *
