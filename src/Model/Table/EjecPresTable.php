 ...
 *
 * @method \App\Model\Entity\EjecPre get($primaryKey, $options = [])
 * @method \App\Model\Entity\EjecPre newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\EjecPre[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\EjecPre|false save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\EjecPre saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\EjecPre patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\EjecPre[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\EjecPre findOrCreate($search, callable $callback = null, $options = [])
 */
class EjecPresTable extends Table
{
    /**
     * Initialize method
     *
