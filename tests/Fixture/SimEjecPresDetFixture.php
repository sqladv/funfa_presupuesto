...
/**
 * SimEjecPresDetFixture
 */
class SimEjecPresDetFixture extends TestFixture
{
    /**
     * Table name
     *
     * @var string
     */
    public $table = 'sim_ejec_pres_det';
    /**
     * Fields
     *
     * @var array
    ...
    public $fields = [
        ...
        'presupuesto_mensual' => ['type' => 'biginteger', 'length' => 20, 'default' => null, 'null' => true, 'comment' => null, 'precision' => null, 'unsigned' => null, 'autoIncrement' => null],
        'gasto_mesnual' => ['type' => 'biginteger', 'length' => 20, 'default' => null, 'null' => true, 'comment' => null, 'precision' => null, 'unsigned' => null, 'autoIncrement' => null],
        'saldo_mensual' => ['type' => 'biginteger', 'length' => 20, 'default' => null, 'null' => true, 'comment' => null, 'precision' => null, 'unsigned' => null, 'autoIncrement' => null],
